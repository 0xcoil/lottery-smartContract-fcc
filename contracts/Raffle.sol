...
// Winner can be selected every X minutes -> completly automated
// Need the ChainLink Oracle -> Randomness, Automated execution (ChainLink Keepers)
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function enterRaffle() public payable {
        // require that msg.value > i_entranceFee
        ...
        // Emit an event when we update a dynamic rray or mapping
    ...
    ) public override returns (bool upkeepNeeded, bytes memory /* perfomData */) {
